  ...
  if (status === 'success') {
    return (
      ...
      >
        ...
        <h3 className="font-serif text-2xl font-semibold text-green-950 mb-2">Request Received!</h3>
        ...
        <button
          ...
          className="mt-6 text-sm font-sans text-gold hover:text-gold-dark transition-colors"
        >
